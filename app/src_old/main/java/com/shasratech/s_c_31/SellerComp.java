...
public class SellerComp extends AppCompatActivity {

    Context mycontext = this;
    private String TAG = "SellerComp";
    ...
    public void on_Modify_PB_Click(View view) {
        Intent SalesComp1_Modify = new Intent(this, SellerComp_Modify.class);
        startActivity(SalesComp1_Modify);
    }

    public void on_DownLoad_PB_Click(View view) {
        DownLoad_Complete_Table_from_Cloud_Act_SellerComp = true;
    }

    public void on_Delete_Data_PB_Click(View view) {
        final String Table = "SellerComp";
            ...
            public void run() {
                Table_Display_Handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Cursor OutputC = myDB_G.ReadData_from_DB_Table(Table, "_id, CompanyName, Address, GST, CompLogo, Disabled, Create_TS, Modify_TS, User", "", "", "CompanyName");

                        if (OutputC != null) {
                            String[] fromFieldNames1 = {"_id", "CompanyName", "Address", "GST", "CompLogo", "Disabled", "Create_TS", "Modify_TS", "User"};
                            ...
                            int[] ToViewIDs = new int[]{R.id.Sales__L_id, R.id.Sales_CompanyName,
                                    R.id.Sales_Address, R.id.Sales_GST, R.id.Sales_CompLogo, R.id.Sales_Disabled, R.id.Sales_Create_TS, R.id.Sales_Modify_TS, R.id.Sales_User};

                            SimpleAdapter k1 = new SimpleAdapter(getBaseContext(), val1, R.layout.sales_inner, fromFieldNames1, ToViewIDs);

                            ListView mySalesComp1_Items1 = (ListView) findViewById(R.id.Material_Header);
                            mySalesComp1_Items1.setAdapter(k1);

                            SimpleCursorAdapter myCursorAdapter;
                            myCursorAdapter = new SimpleCursorAdapter(getBaseContext(), R.layout.sales_inner, OutputC, fromFieldNames1, ToViewIDs, 0);


                            //ListView mySalesComp1_Items = (ListView) findViewById(R.id.SalesComp1_Items_List);
                            GridView mySalesComp1_Items = (GridView) findViewById(R.id.Material_Items_List);
                            mySalesComp1_Items.setAdapter(myCursorAdapter);
                        }
                    }
                });
            }
