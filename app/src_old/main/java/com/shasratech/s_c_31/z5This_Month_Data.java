...
public class z5This_Month_Data extends View {
    private final String TAG = "TransCanvas";
    //private static final Object Color = ;

    public z5This_Month_Data(Context context) {
        super(context);
        //setMinimumWidth(100);
        //setMinimumHeight(100);
    }

    public z5This_Month_Data(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public z5This_Month_Data(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public z5This_Month_Data(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
