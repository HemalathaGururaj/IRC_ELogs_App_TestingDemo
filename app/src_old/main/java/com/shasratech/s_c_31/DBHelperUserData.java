...
public class DBHelperUserData extends SQLiteOpenHelper {
    ...
    public Cursor
    ReadData_from_DB_Table(String tableName, String ColumnName, String Max_Sum_Count, String Condition, String OrderBy) {
...
//        return Insert_update_into_Account_Ordered();
    ...
    boolean Insert_update_into_DriverDetails_Ordered(boolean Insert_I, String Create_TS, String Modify_TS,
        ...
        contentvalues.put("Modify_TS", Modify_TS);
        contentvalues.put("User", User);
        contentvalues.put("Driver_UID", Driver_UID);
        contentvalues.put("Designation", Designation);
        contentvalues.put("PhNum", PhNum);
        contentvalues.put("FullName", FullName);
        contentvalues.put("Address", Address);
        contentvalues.put("Zone", Zone);
        contentvalues.put("Active", Active);

        if ((Get_Val_from_DB_UD("DriverDetails", "Driver_UID", "", "Driver_UID = '" + Driver_UID + "'")).equals(Driver_UID)) {
            Insert = false;
        }

        if (Insert) {
            contentvalues.put("Driver_UID", Driver_UID);
            int ret_val = (int) db_Handle.insertWithOnConflict("DriverDetails", null, contentvalues, SQLiteDatabase.CONFLICT_REPLACE);
            if (ret_val > 0) {
                return true;
            }
        } else {
            String WhereCluause = "Driver_UID = '" + Driver_UID + "'";
            int ret_val = (int) db_Handle.update("DriverDetails", contentvalues,WhereCluause, null  );
            return true;
        }
    ...
    boolean InUp2_DriverDetails ( String P_Key, String[] Con_List, boolean Dynamic_Sync) {
        ...
        if ((Name == null) || (Name.isEmpty())) {
            ...
            if (!Modify_TS.equals(Con_List[1])) {
                Statement = "UPDATE " + Table + " set Modify_TS = '" + Con_List[1] + "', User = '" + Con_List[2]
                        + "', Driver_UID = " + Con_List[4] + ", Designation = "
                        + Con_List[5] + ", PhNum = '" +  Con_List[6] +  "', FullName = '"
                        + ((Con_List[7]).replace('\n', '\05')).replace(',', '\04') + "', Address = '" +  Con_List[8]
                        + "', Zone = '"+ Last
                        +  "' where "  + Sel + ";";
            } else {
                return true;
   ...
   /* boolean Create_Table_Location() {
    ...
    boolean Insert_update_into_Location_Ordered(boolean Insert_I, String Create_TS, String Modify_TS,
        ...
        if ((Get_Val_from_DB_UD("Location", "Location", "", "Location = '" + Location + "'")).equals(Location)) {
            Insert = false;
        }

        if (Insert) {
            contentvalues.put("Location", Location);
            int ret_val = (int) db_Handle.insertWithOnConflict("Location", null, contentvalues, SQLiteDatabase.CONFLICT_REPLACE);
            if (ret_val > 0) {
                return true;
            }
        } else {
            String WhereCluause = "Location = '" + Location + "'";
            int ret_val = (int) db_Handle.update("Location", contentvalues,WhereCluause, null  );
            return true;
        }
...
*/
    ...
    boolean Insert_update_into_LocoDetails_Ordered(boolean Insert_I, String Create_TS, String Modify_TS,
        ...
        contentvalues.put("Modify_TS", Modify_TS);
        contentvalues.put("User", User);
        contentvalues.put("Loco_Num", Loco_Num);
        contentvalues.put("Loco_Type", Loco_Type);
        contentvalues.put("Active", Active);

        if ((Get_Val_from_DB_UD("LocoDetails", "Loco_Num", "", "Loco_Num = '" + Loco_Num + "'")).equals(Loco_Num)) {
            Insert = false;
        }

        if (Insert) {
            contentvalues.put("Loco_Num", Loco_Num);
            int ret_val = (int) db_Handle.insertWithOnConflict("LocoDetails", null, contentvalues, SQLiteDatabase.CONFLICT_REPLACE);
            if (ret_val > 0) {
                return true;
            }
        } else {
            String WhereCluause = "Loco_Num = '" + Loco_Num + "'";
            int ret_val = (int) db_Handle.update("LocoDetails", contentvalues,WhereCluause, null  );
            return true;
        }
    ...
    boolean Create_Table_IRC_ELogs() {
        ...
        db_Handle.execSQL("create table IF NOT EXISTS IRC_ELogs (" +
                ...
                "Fuel_Consmp Text, Lube_Init Text, Lube_Final TEXT ,Lube_Consmp TEXT,CompressorOil TEXT,GovernorOil TEXT,Cool_Wtr TEXT,Driver_Book1 TEXT, " +
                "Driver_Book2 Text, Driver_Book3 Text, Driver_Book4 TEXT ,Driver_Book5 TEXT,Maintenance1, TEXT,Maintenance2 TEXT, Maintenance3 TEXT,Maintenance4 TEXT, " +
                "Maintenance5 Text, StartFuse Text, FireExting TEXT ,FuelFill TEXT,AlertWork TEXT,MUCode TEXT,SPeedoM TEXT,HI_Flash TEXT,LVC_Locks Text, " +
                "GR_Seal Text, DB_Seal Text, Wiper TEXT ,Sanders TEXT,Sig_Drv1 TEXT,DrvName1 TEXT,Sig_Drv2 TEXT,DrvName2 TEXT ,Ticket_P2_1 Text,Shed_P2_1 Text,Ticket_P2_2 Text,Shed_P2_2 Text,Time1 Text,KM1 Text,Motoring1 Text," +
                "Notch1 Text,Load_Read1 Text,Battery_Read1 Text,Time2 Text,KM2 Text,Motoring2 Text,Notch2 Text,Load_Read2 Text,Battery_Read2 Text," +
                "Time3 Text, KM3 Text, Motoring3 Text,Notch3 Text,Load_Read3 Text,Battery_Read3 Text)");
    ...
    boolean Insert_update_into_IRC_ELogs_Ordered(boolean Insert_I, String Create_TS, String Modify_TS,
                                                 ...
                                                 String Fuel_Final, String Lube_Final, String Lube_Consmp, String CompressorOil, String GovernorOil, String Cool_Wtr,
                                                  String Driver_Book1, String Driver_Book2, String Driver_Book3, String Driver_Book4, String Driver_Book5,
                                                 String Maintenance1, String Maintenance2, String Maintenance3, String Maintenance4, String Maintenance5,
                                                 ...
                                                 String DrvName2, String Ticket_P2_1, String Shed_P2_1, String Ticket_P2_2, String Shed_P2_2, String Time1,
                                                 String KM1, String Motoring1, String Notch1, String Load_Read1, String Battery_Read1,
                                                 String Time2, String KM2, String Motoring2, String Notch2, String Load_Read2,
                                                 String Battery_Read2, String Time3, String KM3, String Motoring3, String Notch3,
                                                 String Load_Read3, String Battery_Read3) {
        ...
        contentvalues.put("HomeShed2", HomeShed1);
        ...
        contentvalues.put("Driver_Book1", Driver_Book1);
        contentvalues.put("Driver_Book2", Driver_Book2);
        contentvalues.put("Driver_Book3", Driver_Book3);
        contentvalues.put("Driver_Book4", Driver_Book4);
        contentvalues.put("Driver_Book5", Driver_Book5);
        contentvalues.put("Maintenance1", Maintenance1);
        contentvalues.put("Maintenance2", Maintenance2);
        contentvalues.put(" Maintenance3",  Maintenance3);
        contentvalues.put("Maintenance4", Maintenance4);
        contentvalues.put("Maintenance5", Maintenance5);
        ...
        contentvalues.put("KM1", KM1);
        contentvalues.put("Motoring1", Motoring1);
        contentvalues.put("Notch1", Notch1);
        contentvalues.put("Load_Read1", Load_Read1);
        contentvalues.put("Battery_Read1", Battery_Read1);
        contentvalues.put("Time2", Time2);
        contentvalues.put("KM2", KM2);
        contentvalues.put("Motoring2", Motoring2);
        contentvalues.put("Notch2", Notch2);
        contentvalues.put("Load_Read2", Load_Read2);
        contentvalues.put("Battery_Read2", Battery_Read2);
        contentvalues.put("Time3", Time3);
        contentvalues.put("KM3", KM3);
        contentvalues.put("Motoring3", Motoring3);
        contentvalues.put("Notch3", Notch3);
        contentvalues.put("Load_Read3", Load_Read3);
        contentvalues.put("Battery_Read3", Battery_Read3);
    ...
    boolean InUp2_IRC_ELogs ( String P_Key, String[] Con_List, boolean Dynamic_Sync, String data) {
        String Last = "";
        int ColCount = 83;
        if (Con_List.length < (ColCount -1)) {
            return false;
        ...
        String DS_Update_S = "'" + Con_List[0] + "','" + Con_List[1] + "','" + Con_List[2] + "','"
                ...
                + Con_List[55] + "'," +  Con_List[56] + "," + Con_List[57] + ",'" + Con_List[58] + "','"
                + Con_List[59] + "'," +  Con_List[60] + "," + Con_List[61] + ",'" + Con_List[62] + "','"
                + Con_List[63] + "'," +  Con_List[64] + "," + Con_List[65] + ",'" + Con_List[66] + "','"
                + Con_List[67] + "'," +  Con_List[68] + "," + Con_List[69] + ",'" + Con_List[70] + "','"
                + Con_List[71] + "'," +  Con_List[72] + "," + Con_List[73] + ",'" + Con_List[74] + "','"
                + Con_List[75] + "'," +  Con_List[76] + "," + Con_List[77] + ",'" + Con_List[78] + "','"
                + Con_List[79] + "'," +  Con_List[80] + "," + Con_List[81]
                + "','" + Last + "'";
    ...
    boolean Create_Table_TrainDetails() {
        ...
        db_Handle.execSQL("create table IF NOT EXISTS TrainDetails (" +
                "_id INTEGER PRIMARY KEY AUTOINCREMENT, Create_TS DATETIME, Modify_TS DATETIME, User Text, "
                + "Train_Name Text, Train_Num Text,  Active TEXT) ");

        return true;
    }

    boolean Insert_update_into_TrainDetails_Ordered(boolean Insert_I, String Create_TS, String Modify_TS,
                                                     String User,String Train_Name, String Train_Num, String Active ) {
        ...
        contentvalues.put("Train_Num", Train_Num);
        contentvalues.put("Active", Active);

        if ((Get_Val_from_DB_UD("TrainDetails", "Train_Num", "", "Train_Num = '" + Train_Num + "'")).equals(Train_Num)) {
            Insert = false;
        }

        if (Insert) {
            contentvalues.put("Train_Num", Train_Num);
            int ret_val = (int) db_Handle.insertWithOnConflict("TrainDetails", null, contentvalues, SQLiteDatabase.CONFLICT_REPLACE);
            if (ret_val > 0) {
                return true;
            }
        } else {
            String WhereCluause = "Train_Num = '" + Train_Num + "'";
            int ret_val = (int) db_Handle.update("TrainDetails", contentvalues,WhereCluause, null  );
            return true;
        }
    ...
    boolean InUp2_TrainDetails ( String P_Key, String[] Con_List, boolean Dynamic_Sync) {
        ...
        String data="";
        return InUp2_TrainDetails (  P_Key,  Con_List,  Dynamic_Sync);
    }
    ...
    boolean InUp2_TrainDetails ( String P_Key, String[] Con_List, boolean Dynamic_Sync , String data) {
        ...
        if ((Name == null) || (Name.isEmpty())) {
            ...
            if (!Modify_TS.equals(Con_List[1])) {
                Statement = "UPDATE " + Table + " set Modify_TS = '" + Con_List[1] + "', User = '" + Con_List[2]
                        + "', Train_Num = " + Con_List[4] + ", Train_Name = "
                        + Con_List[5] + ", Active = '"
                        + Last
                        +  "' where "  + Sel + ";";
            } else {
