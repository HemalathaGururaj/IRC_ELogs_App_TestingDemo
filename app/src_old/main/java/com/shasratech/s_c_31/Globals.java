...
public class Globals {
    ...
    public static  String[] Table_List = {"Account", "AutoSaveTrans", "Computers", "CustomerDetails", "Material", "MoneyTransaction",
            "Person", "RFID_Access", "RFID_Insert",  "SellerComp", "Site", "Transactions", "Transport", "Vehicle"};
