...
//        return Insert_update_into_Account_Ordered();
    ...
    boolean InUp2_LocoDetails ( String P_Key, String[] Con_List, boolean Dynamic_Sync, String data) {
        ...
        if (Dynamic_Sync) {
            ...
            Statement = Statement.replace('\05', '\n');
            Statement = Statement.replace('\04', ',');
            Log.i (TAG, "InUp2_LocoDetails statment = " + Statement);
            return RunQueryOnce(Statement);
        }
    }
    ...
    boolean Create_Table_CategorizedSolution() {
        db_Handle.execSQL("create table IF NOT EXISTS CategorizedSolution (" +
                "_id INTEGER PRIMARY KEY AUTOINCREMENT, Create_TS DATETIME, Modify_TS DATETIME, User Text, " +
                " Solution_Id Text, Problem_Id TEXT, Trip_No TEXT, Driver_Name TEXT,Solution_Category TEXT, Solution_Decription TEXT) ");
        return true;
    }
    boolean Insert_update_into_CategorizedSolution_Ordered(boolean Insert_I, String Create_TS, String Modify_TS,
                                                           String User,
                                                           String Solution_Id, String Problem_Id, String Trip_No,String Driver_Name, String Solution_Category, String Solution_Decription) {
        String[] Con_List = new String[9];
        Con_List[0] = Create_TS;
        Con_List[1] = Modify_TS;
        Con_List[2] = User;
        Con_List[3] = Solution_Id;
        Con_List[4] = Problem_Id;
        Con_List[5] = Trip_No;
        Con_List[6] = Driver_Name;
        Con_List[7] = Solution_Category;
    ...
    boolean InUp2_CategorizedSolution( String P_Key, String[] Con_List, boolean Dynamic_Sync, String data) {
        ...
        String Statement;
        if ((Name == null) || (Name.isEmpty())) {
            Statement = "INSERT into " + Table  + "(Create_TS, Modify_TS, User, Solution_Id, Problem_Id, Trip_No, Driver_Name, Solution_Category, Solution_Decription)  values(" + DS_Update_S + ");";
        } else {
            String Modify_TS = Get_Val_from_DB_UD(Table, "Modify_TS", "", Sel);
            if (!Modify_TS.equals(Con_List[1])) {
                Statement = "UPDATE " + Table + " set Modify_TS = '" + Con_List[1] + "', User = '" + Con_List[2]
                        + "', Problem_Id = '" + Con_List[4] + "', Trip_No = '" + Con_List[5] +"', Driver_Name = '" + Con_List[6] +"', Solution_Category = '" + Con_List[7] +
    ...
    boolean Create_Table_IRC_ELogs() {
        ...
        db_Handle.execSQL("create table IF NOT EXISTS IRC_ELogs (" +
                ...
                "Fuel_Consmp Text, Lube_Init Text, Lube_Final TEXT ,Lube_Consmp TEXT,CompressorOil TEXT,GovernorOil TEXT,Cool_Wtr TEXT," +
                        "StartFuse Text, FireExting TEXT ,FuelFill TEXT,AlertWork TEXT,MUCode TEXT,SPeedoM TEXT,HI_Flash TEXT,HVC_Locks Text, " +
    ...
    boolean Insert_update_into_IRC_ELogs_Ordered(boolean Insert_I, String Create_TS, String Modify_TS,
                                                 ...
                                                 String SPeedoM, String HI_Flash, String HVC_Locks, String GR_Seal, String DB_Seal,
        ...
        contentvalues.put("HVC_Locks", HVC_Locks);
    ...
    boolean InUp2_IRC_ELogs ( String P_Key, String[] Con_List_I, boolean Dynamic_Sync, String data) {
        ...
        if ((Name == null) || (Name.isEmpty())) {
            Statement = "INSERT into " + Table  + "(Create_TS, Modify_TS, User, TripNumber, Ticket_Num, Ticket_Num2,HomeShed1,HomeShed2,CrewDetails ,DriverName, DriverDesig, Asst_DriverName, Asst_DriverDesig,Load,KM, TripDetails, Start_P, End_P, TrainNum,\n" +
                    ...
                    "     StartFuse,  FireExting, FuelFill,  AlertWork ,MUCode ,SPeedoM, HI_Flash, HVC_Locks, GR_Seal, DB_Seal, Wiper, Sanders, Sig_Drv1,\n" +
            ...
            if (!Modify_TS.equals(Con_List[1])) {
                Statement = "UPDATE " + Table + " set Modify_TS = '" + Con_List[1] + "', User = '" + Con_List[2]
                        + "', Ticket_Num2 = '" + Con_List[4]
                        + "', HomeShed1 = '" + Con_List[5]
                        + "', HomeShed2 = '" + Con_List[6]
                        + "', CrewDetails = '" + Con_List[7]
                        + "', DriverName = '" + Con_List[8]
                        + "', DriverDesig = '" + Con_List[9]
                        + "', Asst_DriverName = '" + Con_List[10]
                        + "', Asst_DriverDesig = '" + Con_List[11]
                        + "', Load = '" + Con_List[12]
                        + "', KM = '" + Con_List[13]
                        + "', TripDetails = '" + Con_List[14]
                        + "', Start_P = '" + Con_List[15]
                        + "', End_P = '" + Con_List[16]
                        + "', TrainNum = '" + Con_List[17]
                        + "', Attended_At = '" + Con_List[18]
                        + "', Arrival = '" + Con_List[19]
                        + "', Departure = '" + Con_List[20]
                        + "', LocoDetails = '" + Con_List[21]
                        + "', LocoNum = '" + Con_List[22]
                        + "', Last_Sch_Attdnd = '" + Con_List[23]
                        + "', Next_Sch_On = '" + Con_List[24]
                        + "', Level = '" + Con_List[25]
                        + "', Fuel_Init = '" + Con_List[26]
                        + "', Fuel_Final = '" + Con_List[27]
                        + "', Fuel_Consmp = '" + Con_List[28]
                        + "', Lube_Init = '" + Con_List[29]
                        + "', Lube_Final = '" + Con_List[30]
                        + "', Lube_Consmp = '" + Con_List[31]
                        + "', CompressOil = '" + Con_List[32]
                        + "', GovernorOil = '" + Con_List[33]
                        + "', Cool_Wtr = '" + Con_List[34]



                        + "', StartFuse = '" + Con_List[35]
                        + "', FireExting = '" + Con_List[36]
                        + "', FuelFill = '" + Con_List[37]
                        + "', AlertWork = '" + Con_List[38]
                        + "', MUCode = '" + Con_List[39]
                        + "', SPeedoM = '" + Con_List[40]
                        + "', HI_Flash = '" + Con_List[41]
                        + "', HVC_Locks = '" + Con_List[42]
                        + "', GR_Seal = '" + Con_List[43]
                        + "', DB_Seal = '" + Con_List[44]
                        + "', Wiper = '" + Con_List[45]
                        + "', Sanders = '" + Con_List[46]

                        + "', Sig_Drv1 = '" + Con_List[47]
                        + "', DrvName1 = '" + Con_List[48]

                        + "', Sig_Drv2 = '" + Con_List[49]
                        + "', DrvName2 = '" + Con_List[50]

                        + "', Ticket_P2_1 = '" + Con_List[51]
                        + "', Shed_P2_1 = '" + Con_List[52]

                        + "', Ticket_P2_2 = '" + Con_List[53]
                        + "', Shed_P2_2 = '" + Con_List[54]
