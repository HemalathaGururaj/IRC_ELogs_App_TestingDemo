...
public class IRC_ELogs extends AppCompatActivity {
    ...
    private String TAG = "IRC_ELogs";
    private Handler Table_Display_Handler = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.irc_elogs_activity);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.irc_elogs, menu);
        return true;
    }
    ...
    public void on_Modify_PB_Click(View view) {
        Intent Material_Modify = new Intent(this, IRC_ELogs_Modify.class);
    ...
    public void on_DownLoad_PB_Click(View view) {
        ...
        Log.i (TAG, "DownLoad_Complete_Table_from_Cloud_Act_IRC_ELogs true");
    }
                ...
                Table_Display_Handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Cursor OutputC = myDB_G.ReadData_from_DB_Table(Table, "_id,Ticket_Num, Ticket_Num2,HomeShed1,HomeShed2,CrewDetails ,DriverName,Asst_DriverDesig,Load,KM, TripDetails, Start_P, End_P, TrainNum," +
                                ...
                                " DrvName1,  Sig_Drv2, DrvName2 ,Ticket_P2_1, Shed_P2_1, Ticket_P2_2 ,Shed_P2_2 ,Create_TS, Modify_TS, User", "", "", "Ticket_Num");
                        ...
                        if (OutputC != null) {
                            ...
                            String[] fromFieldNames1 = {"_id","Ticket_Num","Ticket_Num2","HomeShed1","HomeShed2","CrewDetails","DriverName","Asst_DriverDesig","Load","KM","TripDetails", "Start_P", "End_P", "TrainNum", "Attended_At",
                                    ...
                                    "Cool_Wtr",
                                     "StartFuse",  "FireExting", "FuelFill",  "AlertWork","MUCode","SPeedoM", "HI_Flash", "HVC_Locks", "GR_Seal", "DB_Seal", "Wiper", "Sanders", "Sig_Drv1",
                                    "DrvName1","Sig_Drv2", "DrvName2","Ticket_P2_1", "Shed_P2_1", "Ticket_P2_2","Shed_P2_2" ,"Create_TS", "Modify_TS", "User"};
                            ...
                            int[] ToViewIDs = new int[]{R.id.IRC_ELogs__L_id,R.id.IRC_ELogs_Ticket_Num,R.id.IRC_ELogs_Ticket_Num2, R.id.IRC_ELogs_HomeShed1,R.id.IRC_ELogs_HomeShed2,R.id.IRC_ELogs_CrewDetails,R.id.IRC_ELogs_DriverName,R.id.IRC_ELogs_Asst_DriverDesig,R.id.IRC_ELogs_Load,R.id.IRC_ELogs_KM,
                           R.id.IRC_ELogs_TripDetails, R.id.IRC_ELogs_Start_P,  R.id.IRC_ELogs_End_P, R.id.IRC_ELogs_TrainNum, R.id.IRC_ELogs_Attended_At,  R.id.IRC_ELogs_Arrival,
                                    ...
                                    R.id.IRC_ELogs_Cool_Wtr,
                                     R.id.IRC_ELogs_StartFuse,  R.id.IRC_ELogs_FireExting, R.id.IRC_ELogs_FuelFill,  R.id.IRC_ELogs_AlertWork ,R.id.IRC_ELogs_MUCode ,R.id.IRC_ELogs_SPeedoM, R.id.IRC_ELogs_HI_Flash, R.id.IRC_ELogs_HVC_Locks, R.id.IRC_ELogs_GR_Seal, R.id.IRC_ELogs_DB_Seal, R.id.IRC_ELogs_Wiper, R.id.IRC_ELogs_Sanders, R.id.IRC_ELogs_Sig_Drv1,
                                    R.id.IRC_ELogs_DrvName1, R.id.IRC_ELogs_Sig_Drv2, R.id.IRC_ELogs_DrvName2 ,R.id.IRC_ELogs_Ticket_P2_1, R.id.IRC_ELogs_Shed_P2_1, R.id.IRC_ELogs_Ticket_P2_2 ,R.id.IRC_ELogs_Shed_P2_2 , R.id.IRC_ELogs__Create_TS, R.id.IRC_ELogs__Modify_TS, R.id.IRC_ELogs__User,};
