...
import static com.shasratech.s_c_31.Globals.DownLoad_Complete_Table_from_Cloud_Act_TrainDetails;
...
public class TrainDetails extends AppCompatActivity {
    ...
    public void on_Modify_PB_Click(View view) {
        Intent Material_Modify = new Intent(this, TrainDetails_Modify.class);
        startActivity(Material_Modify);
    }

    public void on_DownLoad_PB_Click(View view) {
        DownLoad_Complete_Table_from_Cloud_Act_TrainDetails = true;
    }
            ...
            public void run() {
                Table_Display_Handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Cursor OutputC = myDB_G.ReadData_from_DB_Table(Table, "_id, Train_Name,Active, Train_Num, Create_TS, Modify_TS, User", "", "", "Train_Num");

                        if (OutputC != null) {

                            String[] fromFieldNames1 = {"_id", "Train_Name","Active", "Train_Num","Create_TS", "Modify_TS", "User"};
                            ...
                            int[] ToViewIDs = new int[]{R.id.traindetails_L_id, R.id.traindetails_Train_Name, R.id.traindetails_Active, R.id.traindetails_Train_Num,R.id.traindetails_Create_TS,  R.id.traindetails_Modify_TS, R.id.traindetails_User};
                            SimpleAdapter k1 = new SimpleAdapter(getBaseContext(), val1, R.layout.traindetails_inner, fromFieldNames1, ToViewIDs);

                            ListView myMaterial_Items1 = (ListView) findViewById(R.id.Material_Header);
                            myMaterial_Items1.setAdapter(k1);

                            SimpleCursorAdapter myCursorAdapter;
                            myCursorAdapter = new SimpleCursorAdapter(getBaseContext(), R.layout.traindetails_inner, OutputC, fromFieldNames1, ToViewIDs, 0);
