...
public class RFID_Access extends AppCompatActivity {

    Context mycontext = this;
    private String TAG = "RFID_Access";
    ...
    public void on_DownLoad_PB_Click(View view) {
        DownLoad_Complete_Table_from_Cloud_Act_RFID_Access = true;
    }

    public void on_Delete_Data_PB_Click(View view) {
        final String Table = "RFID_Access";
            ...
            public void run() {
                Table_Display_Handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Cursor OutputC = myDB_G.ReadData_from_DB_Table(Table, "_id, AccessTS, id, RFID_id, Vehicle, Load", "", "", "AccessTS Desc");

                        if (OutputC != null) {

                            String[] fromFieldNames1 = {"_id", "AccessTS", "id", "RFID_id", "Vehicle", "Load"};
                            ...
                            int[] ToViewIDs = new int[]{R.id.RFID_Access__L_id, R.id.RFID_Access_Time, R.id.RFID_Access_id, R.id.RFID_Access_RFID_ID, R.id.RFID_Access_Vehicle,
                                    R.id.RFID_Access_Load};

                            SimpleAdapter k1 = new SimpleAdapter(getBaseContext(), val1, R.layout.rfid_access_inner, fromFieldNames1, ToViewIDs);

                            ListView myRFID_Access_Items1 = (ListView) findViewById(R.id.Material_Header);
                            myRFID_Access_Items1.setAdapter(k1);

                            SimpleCursorAdapter myCursorAdapter;
                            myCursorAdapter = new SimpleCursorAdapter(getBaseContext(), R.layout.rfid_access_inner, OutputC, fromFieldNames1, ToViewIDs, 0);

                            GridView myRFID_Access_Items = (GridView) findViewById(R.id.Material_Items_List);
                            myRFID_Access_Items.setAdapter(myCursorAdapter);
