...
public class RFID_Insert extends AppCompatActivity {
            ...
            public void run() {
                Table_Display_Handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Cursor OutputC = myDB_G.ReadData_from_DB_Table(Table, "_id,  Create_TS, Modify_TS, User, RFID_id, Supplier, Vehicle, Material, Disabled", "", "", "Create_TS Desc");

                        if (OutputC != null) {

                            String[] fromFieldNames1 = {"_id",  "Create_TS", "Modify_TS", "User", "RFID_id", "Supplier", "Vehicle", "Material", "Disabled"};
                            ...
                            int[] ToViewIDs = new int[]{R.id.RFID_Insert__L_id, R.id.RFID_Insert_Create_TS, R.id.RFID_Insert_Modify_TS, R.id.RFID_Insert_User, R.id.RFID_Insert_RFID_ID,
                                    R.id.RFID_Insert_Supplier, R.id.RFID_Insert_Vehicle, R.id.RFID_Insert_Material, R.id.RFID_Insert_Disabled };

                            SimpleAdapter k1 = new SimpleAdapter(getBaseContext(), val1, R.layout.rfid_insert_inner, fromFieldNames1, ToViewIDs);

                            ListView myRFID_Insert_Items1 = (ListView) findViewById(R.id.Material_Header);
