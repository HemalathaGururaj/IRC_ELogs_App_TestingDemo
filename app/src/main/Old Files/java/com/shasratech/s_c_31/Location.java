...
import static com.shasratech.s_c_31.Globals.DownLoad_Complete_Table_from_Cloud_Act_Location;
...
public class Location extends AppCompatActivity {
    ...
    public void on_Location_Modify_PB_ClicK(View view) {
        Intent inent = new Intent(this, MainActivity.class);
        startActivity(inent);
    }
    ...
    public void on_Modify_PB_Click(View view) {
        Intent Material_Modify = new Intent(this, Location_Modify.class);
        startActivity(Material_Modify);
    }

    public void on_DownLoad_PB_Click(View view) {
        DownLoad_Complete_Table_from_Cloud_Act_Location = true;
    }
            ...
            public void run() {
                Table_Display_Handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Cursor OutputC = myDB_G.ReadData_from_DB_Table(Table, "_id, Location,Active, Zone, Create_TS, Modify_TS, User", "", "", "Location");

                        if (OutputC != null) {

                            String[] fromFieldNames1 = {"_id", "Location","Active", "Zone","Create_TS", "Modify_TS", "User"};
                            ...
                            int[] ToViewIDs = new int[]{R.id.location_L_id, R.id.location_Location, R.id.location_Active, R.id.location_Zone,R.id.location_Create_TS,  R.id.location_Modify_TS, R.id.location_User};
                            SimpleAdapter k1 = new SimpleAdapter(getBaseContext(), val1, R.layout.location_inner, fromFieldNames1, ToViewIDs);

                            ListView myMaterial_Items1 = (ListView) findViewById(R.id.Material_Header);
                            myMaterial_Items1.setAdapter(k1);

                            SimpleCursorAdapter myCursorAdapter;
                            myCursorAdapter = new SimpleCursorAdapter(getBaseContext(), R.layout.location_inner, OutputC, fromFieldNames1, ToViewIDs, 0);
