...
public class CategorizedSolution extends AppCompatActivity {

    Context mycontext = this;
    private String TAG = "CategorizedSolution";
            ...
            public void run() {
                Table_Display_Handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Cursor OutputC = myDB_G.ReadData_from_DB_Table(Table, "_id, Solution_Id,Problem_Id, Trip_No, Driver_Name, Solution_Category, Solution_Decription,  Create_TS, Modify_TS, User", "", "", "Solution_Id");

                        if (OutputC != null) {

                            String[] fromFieldNames1 = {"_id", "Solution_Id", "Problem_Id", "Trip_No", "Driver_Name", "Solution_Category", "Solution_Decription",  "Create_TS", "Modify_TS", "User"};
