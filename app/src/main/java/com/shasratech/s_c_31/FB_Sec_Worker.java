...
public class FB_Sec_Worker extends Thread {
    ...
    private  DatabaseReference mFDB_Monitor = null;
    ...
    private void Add_Change_Listener() {
        ...
        mFDB_Monitor = mFDB.getReference(FBAppName).child(FBAppCustomer).child("Monitor");
...
*/
                    ...
                    mFDB_Temp.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            switch (Table) {
                                ...
                                case "Monitor":
                                    DB_Update_Response = myDB_L.InUp2_Monitor(P_Key, Con_List, false);
                                    break;
    ...
    public void run () {
        ...
        while (true) {
            ...
            if (DownLoad_Complete_Table_from_Cloud_Act_Monitor) {
                DownLoad_Complete_Table_from_Cloud_Act_Monitor = false;
                DownLoad_Complete_Table_from_Cloud(Curr_Activity.Act_Monitor);
            }
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            for (DataSnapshot child : dataSnapshot.getChildren()) {
                                ...
                                switch (Activity) {
                                    ...
                                    case Act_Monitor:
                                        myDB_L.InUp2_Monitor(P_Key, Con_List, false,  data);
                                        break;
                                    case Act_CategorizedSolution:
                            ...
                            switch (Activity) {
                                ...
                                case Act_Monitor:
                                    Intent Monitor = new Intent(myGContext_Global , Monitor.class);
                                    myGContext_Global.startActivity(Monitor);
                                    break;
                                case Act_CategorizedProblem:
                                    ...
                                    break;
                                case Act_CategorizedSolution:
                                    Intent CategorizedSolution = new Intent(myGContext_Global , com.shasratech.s_c_31.CategorizedSoultion.class);
