...
import static com.shasratech.s_c_31.Globals.DownLoad_Complete_Table_from_Cloud_Act_AppUsers;
...
public class AppUsers extends AppCompatActivity {
    ...
    private String TAG = "AppUsers";
    private Handler Table_Display_Handler = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.appusers_activity);
    ...
    public void on_Modify_PB_Click(View view) {
        Intent Table_Modify = new Intent(this, AppUsers_Modify.class);
        startActivity(Table_Modify);
    }

    public void on_DownLoad_PB_Click(View view) {
        DownLoad_Complete_Table_from_Cloud_Act_AppUsers = true;
    }
    public void on_Delete_Data_PB_Click(View view) {
        final String Table = "AppUsers";
            ...
            public void run() {
                Table_Display_Handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Cursor OutputC =  myDB_G.ReadData_from_DB_Table(Table, "_id,Name,Groups,Disabled,TimeStamp", "", "", "Name");

                        if (OutputC != null) {
                            String[] fromFieldNames1 = {"_id", "Name", "Groups", "Disabled", "TimeStamp"};
                            ...
                            int[] ToViewIDs = new int[]{R.id.AppUsers_L_id, R.id.AppUsers_Name,  R.id.AppUsers_Group, R.id.AppUsers_Disabled, R.id.AppUsers_TimeStamp};

                            SimpleAdapter k1 = new SimpleAdapter(getBaseContext(), val1, R.layout.appusers_inner, fromFieldNames1, ToViewIDs);

                            ListView mySite_Items1 = (ListView) findViewById(R.id.Material_Header);
                            mySite_Items1.setAdapter(k1);

                            SimpleCursorAdapter myCursorAdapter;
                            myCursorAdapter = new SimpleCursorAdapter(getBaseContext(), R.layout.appusers_inner, OutputC, fromFieldNames1, ToViewIDs, 0);
