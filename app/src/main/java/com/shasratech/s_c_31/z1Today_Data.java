...
public class z1Today_Data extends View {
    private final String TAG = "TransCanvas";
    //private static final Object Color = ;

    public z1Today_Data(Context context) {
        super(context);
        //setMinimumWidth(100);
        //setMinimumHeight(100);
    }

    public z1Today_Data(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public z1Today_Data(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public z1Today_Data(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onDraw(Canvas cv) {
        ...
        String Start_Date =  Get_Current_Date_Time(System_Date_Format);
        String End_Date = Get_Current_Date_Time(System_Date_Format);
        String WhereClause_Today = " Create_TS >= '" + Start_Date + " 00:00:00' and Create_TS <= '" + End_Date + " 23:59:59' and Empty = 'NO' and In_Out = 'SALE'";

        String Statement = "Select SUM(Met_Weight), Material from Transactions where " + WhereClause_Today  + " and Empty = 'NO' group by Material order by 1 Desc";
