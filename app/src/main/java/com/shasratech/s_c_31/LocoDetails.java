...
import static com.shasratech.s_c_31.Globals.DownLoad_Complete_Table_from_Cloud_Act_LocoDetails;
import static com.shasratech.s_c_31.Globals.ErrMsgDialog;
import static com.shasratech.s_c_31.Globals.myDB_G;

public class LocoDetails extends AppCompatActivity {

    Context mycontext = this;
    private String TAG = "LocoDetails";
    private Handler Table_Display_Handler = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.locodetails_activity);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.locodetails, menu);
        return true;
    }
    ...
    public void on_Modify_PB_Click(View view) {
        Intent HomeShed_Modify = new Intent(this, LocoDetails_Modify.class);
        startActivity(HomeShed_Modify);
    }

    public void on_DownLoad_PB_Click(View view) {
        DownLoad_Complete_Table_from_Cloud_Act_LocoDetails = true;
    }
            ...
            public void run() {
                Table_Display_Handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Cursor OutputC = myDB_G.ReadData_from_DB_Table(Table, "_id, Loco_Num,Active, Loco_Type, Create_TS, Modify_TS, User", "", "", "Loco_num");

                        if (OutputC != null) {

                            String[] fromFieldNames1 = {"_id", "Loco_Num","Active", "Loco_Type","Create_TS", "Modify_TS", "User"};
                            ...
                            int[] ToViewIDs = new int[]{R.id.locodetails_L_id, R.id.locodetails_Loco_Num, R.id.locodetails_Active, R.id.locodetails_Loco_Type,R.id.locodetails_Create_TS,  R.id.locodetails_Modify_TS, R.id.locodetails_User};
                            SimpleAdapter k1 = new SimpleAdapter(getBaseContext(), val1, R.layout.locodetails_inner, fromFieldNames1, ToViewIDs);

                            ListView myMaterial_Items1 = (ListView) findViewById(R.id.Material_Header);
                            myMaterial_Items1.setAdapter(k1);

                            SimpleCursorAdapter myCursorAdapter;
                            myCursorAdapter = new SimpleCursorAdapter(getBaseContext(), R.layout.locodetails_inner, OutputC, fromFieldNames1, ToViewIDs, 0);
