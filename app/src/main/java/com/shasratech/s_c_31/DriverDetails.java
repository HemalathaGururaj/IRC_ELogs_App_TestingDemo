...
import static com.shasratech.s_c_31.Globals.DownLoad_Complete_Table_from_Cloud_Act_DriverDetails;
...
public class DriverDetails extends AppCompatActivity {
    ...
    private String TAG = "DriverDetails";
    ...
    public void on_Modify_PB_Click(View view) {
        Intent DriverDetails_Modify = new Intent(this, DriverDetails_Modify.class);
        startActivity(DriverDetails_Modify);
    }

    public void on_DownLoad_PB_Click(View view) {
        DownLoad_Complete_Table_from_Cloud_Act_DriverDetails = true;
    }
            ...
            public void run() {
                Table_Display_Handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Cursor OutputC = myDB_G.ReadData_from_DB_Table(Table, "_id,Driver_UID,Designation,Address,FullName,Zone,PhNum,Active,  Create_TS, Modify_TS, User", "", "", "Driver_UID");

                        if (OutputC != null) {

                            String[] fromFieldNames1 = {"_id", "Driver_UID","Designation","Address","FullName","Zone","PhNum","Active", "Create_TS", "Modify_TS", "User"};
                            ...
                            int[] ToViewIDs = new int[]{R.id.driverdetails__L_id,R.id.driverdetails_Driver_UID,R.id.driverdetails_Designation,R.id.driverdetails_Address,R.id.driverdetails_FullName,R.id.driverdetails_Zone,R.id.driverdetails_PhNum,R.id.driverdetails_Active, R.id.driverdetails_Create_TS,  R.id.driverdetails_Modify_TS, R.id.driverdetails_User};
                            SimpleAdapter k1 = new SimpleAdapter(getBaseContext(), val1, R.layout.driverdetails_inner, fromFieldNames1, ToViewIDs);

                            ListView myMaterial_Items1 = (ListView) findViewById(R.id.Material_Header);
                            myMaterial_Items1.setAdapter(k1);

                            SimpleCursorAdapter myCursorAdapter;
                            myCursorAdapter = new SimpleCursorAdapter(getBaseContext(), R.layout.driverdetails_inner, OutputC, fromFieldNames1, ToViewIDs, 0);
