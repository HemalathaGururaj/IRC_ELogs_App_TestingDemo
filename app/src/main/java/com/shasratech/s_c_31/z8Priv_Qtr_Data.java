...
public class z8Priv_Qtr_Data extends View {
    private final String TAG = "TransCanvas";
    //private static final Object Color = ;

    public z8Priv_Qtr_Data(Context context) {
        super(context);
        //setMinimumWidth(100);
        //setMinimumHeight(100);
    }

    public z8Priv_Qtr_Data(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public z8Priv_Qtr_Data(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public z8Priv_Qtr_Data(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
