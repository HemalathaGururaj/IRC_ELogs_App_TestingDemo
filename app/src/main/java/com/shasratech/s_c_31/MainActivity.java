...
/*
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_appUsers:
                Intent AppUsers = new Intent(MainActivity.this, AppUsers.class);
                startActivity(AppUsers);
                break;
            ...
            case R.id.nav_CategorizedProblem:
                Intent HomeShed1 = new Intent(MainActivity.this, CategorizedProblem.class);
                startActivity(HomeShed1);
                break;
            case R.id.nav_CategorizedSoultion:
                Intent CategorizedSoultion = new Intent(MainActivity.this, CategorizedSoultion.class);
                startActivity(CategorizedSoultion);
                break;
            case R.id.nav_TrainDetails:
                Intent TrainDetails = new Intent(MainActivity.this, TrainDetails.class);
                startActivity(TrainDetails);
                break;
            case R.id.nav_DriverDetails:
                Intent DriverDetails = new Intent(MainActivity.this, DriverDetails.class);
                startActivity(DriverDetails);
                break;
            case R.id.nav_LocoDetails:
                Intent LocoDetails = new Intent(MainActivity.this, LocoDetails.class);
                startActivity(LocoDetails);
                break;
