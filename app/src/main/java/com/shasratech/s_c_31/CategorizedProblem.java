...
import static com.shasratech.s_c_31.Globals.DownLoad_Complete_Table_from_Cloud_Act_CategorizedProblem;
import static com.shasratech.s_c_31.Globals.ErrMsgDialog;
import static com.shasratech.s_c_31.Globals.myDB_G;

public class CategorizedProblem extends AppCompatActivity {

    Context mycontext = this;
    private String TAG = "CategorizedProblem";
    private Handler Table_Display_Handler = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.categorizedproblem_activity);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.categorizedproblem, menu);
        return true;
    }
    ...
    public void on_Modify_PB_Click(View view) {
        Intent HomeShed_Modify = new Intent(this, CategorizedProblem_Modify.class);
        startActivity(HomeShed_Modify);
    }

    public void on_DownLoad_PB_Click(View view) {
        DownLoad_Complete_Table_from_Cloud_Act_CategorizedProblem = true;
    }

    public void on_Delete_Data_PB_Click(View view) {
        final String Table = "CategorizedProblem";
            ...
            public void run() {
                Table_Display_Handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Cursor OutputC = myDB_G.ReadData_from_DB_Table(Table, "_id, Problem_Id,Trip_No, Driver_Name,Problem_Category,Problem_Decription, Create_TS, Modify_TS, User", "", "", "Problem_Id");

                        if (OutputC != null) {

                            String[] fromFieldNames1 = {"_id", "Problem_Id","Trip_No", "Driver_Name","Problem_Category","Problem_Decription","Create_TS", "Modify_TS", "User"};
                            ...
                            int[] ToViewIDs = new int[]{R.id.problem_L_id, R.id.problem_problemId, R.id.problem_drivename, R.id.prblem_tripno,R.id.prblem_problemcategory,R.id.prblem_problemdecription,R.id.problem_Create_TS,  R.id.problem_Modify_TS, R.id.problem_User};
                            SimpleAdapter k1 = new SimpleAdapter(getBaseContext(), val1, R.layout.categorizedproblem_inner, fromFieldNames1, ToViewIDs);

                            ListView myMaterial_Items1 = (ListView) findViewById(R.id.Material_Header);
                            myMaterial_Items1.setAdapter(k1);

                            SimpleCursorAdapter myCursorAdapter;
                            myCursorAdapter = new SimpleCursorAdapter(getBaseContext(), R.layout.categorizedproblem_inner, OutputC, fromFieldNames1, ToViewIDs, 0);
