...
public class z2YesterDay_Data extends View {
    private final String TAG = "TransCanvas";
    //private static final Object Color = ;

    public z2YesterDay_Data(Context context) {
        super(context);
        //setMinimumWidth(100);
        //setMinimumHeight(100);
    }

    public z2YesterDay_Data(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public z2YesterDay_Data(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public z2YesterDay_Data(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
