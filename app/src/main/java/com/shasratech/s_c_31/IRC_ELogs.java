                        ...
                        if (OutputC != null) {
                           ...
                           R.id.IRC_ELogs_TripDetails, R.id.IRC_ELogs_Start_P,  R.id.IRC_ELogs_End_P, R.id.IRC_ELogs_TrainNum, R.id.IRC_ELogs_Attended_At,  R.id.IRC_ELogs_Arrival,
                                    ...
                                    R.id.IRC_ELogs_Cool_Wtr,
                                     R.id.IRC_ELogs_StartFuse,  R.id.IRC_ELogs_FireExting, R.id.IRC_ELogs_FuelFill,  R.id.IRC_ELogs_AlertWork ,R.id.IRC_ELogs_MUCode ,R.id.IRC_ELogs_SPeedoM, R.id.IRC_ELogs_HI_Flash, R.id.IRC_ELogs_LVC_Locks, R.id.IRC_ELogs_GR_Seal, R.id.IRC_ELogs_DB_Seal, R.id.IRC_ELogs_Wiper, R.id.IRC_ELogs_Sanders, R.id.IRC_ELogs_Sig_Drv1,
